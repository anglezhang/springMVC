...
<body class="logBj logBj_2" onkeypress="goEnter(event)">
        ...
        <div class="logCon_inp">
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="logTabale">
               <tr>
                ...
                <tr>
                    <td colspan="2"><input id="username" name="username" type="text" onfocus="clearError();" maxlength="100" class="tab_name" placeholder="用户名" /></td>
                ...
                <tr>
                    <td colspan="2" align="center"><input type="button" onclick="goSubmit()" value="登录" class="logBtn_h"  /></td>
                    <td></td>
                </tr>
            </table>
      </div>
