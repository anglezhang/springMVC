package com.zoomoor.common.hibernate3;
...
import com.zoomoor.common.util.MyBeanUtils;
 ...
 *            entity id
 */
public abstract class HibernateBaseDao<T, PK extends Serializable> extends
		HibernateSimpleDao {
	/**
	...
	protected T get(PK id, boolean lock) {
		T entity;
		if (lock) {
