			...
			<table class="table" width="100%">
				<tr>
					...
					<td >
						...
						<input id="platenum" name="infoCar.platenum" type="text"  maxlength="30" class="required" readonly="readonly" size="30" onchange="clealCarInf()"/>
					</td>
					<td width="100">客户姓名：</td>
					<td width="400">
						<input id="customerName" type="text"  maxlength="30" class="required" readonly="readonly" size="30" />
						<input id="customerId" type="hidden" name="infoCustomer.customerId" maxlength="30"  />
