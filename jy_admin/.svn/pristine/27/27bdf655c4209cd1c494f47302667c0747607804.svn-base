...
import com.zoomoor.common.web.Constants;
import com.zoomoor.common.web.RequestUtils;
import com.zoomoor.common.web.session.cache.SessionCache;
import com.zoomoor.common.web.session.id.SessionIdGenerator;
...
public class CacheSessionProvider implements SessionProvider,InitializingBean {
	...
	public void setUserSession(HttpServletRequest request,
			HttpServletResponse response, String name, SysUser user) {
		// TODO Auto-generated method stub
	...
	@Override
	public void setIsSuperSession(HttpServletRequest request,
			HttpServletResponse response, String name, boolean isSuper) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public HashSet<SysAuth> getAuthSession(HttpServletRequest request,
			String name) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public void setAuthSession(HttpServletRequest request,
			HttpServletResponse response, String name, HashSet<SysAuth> authSet) {
		// TODO Auto-generated method stub
