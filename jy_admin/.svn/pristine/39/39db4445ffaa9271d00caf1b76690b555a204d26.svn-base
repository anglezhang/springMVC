	...
	<div class="panelBar">
		<ul class="toolBar">
			<tag:auth code="allocation.add">
				<li><a class="add" href="${pageContext.request.contextPath}/allocation/add.do" target="dialog"  width="1200" height="700" mask="true" rel="dh_zl_dept_view"><span>创建调拨</span></a></li>
			</tag:auth>
		</ul>
	</div>
