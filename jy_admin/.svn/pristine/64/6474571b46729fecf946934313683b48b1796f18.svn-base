...
<div class="pageContent">
	<form method="post" action="${pageContext.request.contextPath}/fourshop/savepay.html" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="60">
			<input name="entrustId" type="hidden" value="${custEntrus.entrustId}">
			<table >
				<tr>
					<td>
						<div class="unit">
				...
				<tr>
					<td>
						<div class="unit">
							<label>应收费用</label>
							<input type="text" name="shopmonney" maxlength="6" readonly="readonly" value="${custEntrus.shopmonney}" size="30" />
						</div>
					</td>
				</tr>
				<tr>
					<td>
						<div class="unit">
							<label>确认收款额度</label>
							<input type="text" name="amount" maxlength="6" class="number" size="30" />
						</div>
					</td>
				</tr>
			</table>
		...
		<div class="formBar">
			<ul>
				<li>
					<div class="buttonActive"><div class="buttonContent"><button type="submit">确认收款</button></div></div>
				</li>
				<li>
