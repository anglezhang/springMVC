package com.zoomoor.common.web.freemarker;

import static com.zoomoor.common.web.ProcessTimeFilter.START_TIME;
 ...
 * 执行时间标签
 * 
 * 需要拦截器com.zoomoor.common.web.ProcessTimeFilter支持
 */
