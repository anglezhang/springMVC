package com.zoomoor.common.image;
...
import com.zoomoor.common.image.ImageUtils.Position;
...
public class MagickImageScale {
	...
	public static void main(String[] args) throws Exception {
		...
		MagickImageScale.resizeFix(
				new File("test/com/zoomoor/common/util/1.bmp"), new File(
						"test/com/zoomoor/common/util/1-n-3.bmp"), 310, 310, 50,
				50, 320, 320);
