...
<div class="pageContent">
	<table class="table" width="100%" layoutH="145">
		...
		<tbody>
			<c:forEach items="${pagercancel.list}" var="customerAppoit" varStatus="s">
				<tr>
					<td>
	...
	<div class="panelBar">
		<div class="pages">
			...
			<span>条，共${pagercancel.totalCount}条</span>
		</div>
		
		<div class="pagination" targetType="navTab" totalCount="${pagercancel.totalCount}" numPerPage="${pagercancel.numPerPage}" pageNumShown="10" currentPage="${pagercancel.pageNum}"></div>
	</div>
	<script>
		$("select[name='numPerPage']").val('${pagercancel.numPerPage}');
	</script>
</div>
