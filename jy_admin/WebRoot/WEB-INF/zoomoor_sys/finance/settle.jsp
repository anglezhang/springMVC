...
<div class="pageContent">
	<form method="post" action="${pageContext.request.contextPath}/settlement/settlesave.do" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		...
		<div class="formBar">
			<ul>
				<tag:auth code="settlement.billsave.do">
					<li>
						<div class="buttonActive"><div class="buttonContent"><button type="submit">确认结清</button></div></div>
					</li>
				</tag:auth>
				<li>
