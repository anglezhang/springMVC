		...
		<div class="pageFormContent" layoutH="60">
			...
			<table class="table" width="100%">
				...
				<tr>
					...
					<td width="40%">
						<c:forEach items="${emps}" var="infoEmp" varStatus="s">
							<c:if test="${cusEntity.receptionist eq infoEmp.empId}" >${infoEmp.empName}(${infoEmp.paramConfig.name})</c:if> 
						</c:forEach>
					</td>
					<td width="10%">开单时间</td>
					<td width="40%">
				...
				<tr>
					...
					<td>
						<c:forEach items="${emps}" var="infoEmp" varStatus="s">
							<c:if test="${cusEntity.fixer eq infoEmp.empId}" >${infoEmp.empName}(${infoEmp.paramConfig.name})</c:if> 
						</c:forEach>
					</td>
				</tr>
				<tr>
