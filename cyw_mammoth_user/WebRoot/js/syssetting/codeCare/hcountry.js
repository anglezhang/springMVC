...
//国家
function fillHcountryTable(listJson , status){
	...
	flexGrid = new wijmo.grid.FlexGrid('#theGrid', {
			...
			columns:[
			    ...
			    { header:"fillTemp3",binding:"",name:"fillTemp3" ,isReadOnly:true,visible:false}, 
			    ...
			    { header:"区号",binding:"zoneId",name:"h_zoneId" , align:"center", minWidth:40, width:80,isReadOnly:!status_search,mask:'AAAAAA'},
	...
	flexGrid.selectionChanged.addHandler(function(s, e){
		...
		/*var selection = getSelectionRanges();
			...
			if(status_search && (!dataItem || (dataItem.codeKind == 1))){
				temp =false ;
				break ;
			}
		}*/
...
//国家
function packHcountryData(addItems , editItems){
