...
//国家
function fillHsetlKindTable(listJson , status){
	...
	flexGrid = new wijmo.grid.FlexGrid('#theGrid', {
			...
			columns:[
			    ...
			    { header:"信用限额",binding:"limit",name:"h_limit" , align:"right", minWidth:40, width:100,isReadOnly:!status_search,format:"n2"},
...
//国家
function packHsetlKindData(addItems , editItems){
