	...
	<div class="alertDiv checkInDiv moveBar checkDetailsDiv" id="checkDetailsDiv">
		<div class="alertMain greyBg rzLogin" style="margin-top:5px;">
			<h4 class="moveDivAlert" id="MoveAlertDiv">
				客单详情（在住 / 离店）<a href="javascript:;" class="hideDivOne" id="guestdetail_closewindow" onclick="quitWindow()"></a>
			</h4>
							...
							<div class="tableDivDow clearBoth margin-bottom-10 floatL">
								<table width="99%">
									<tr>
										...
										<td width="130" id="append"><input class="input validate[required]" onkeypress="namePress(event)" data-validation="isHanZi" maxlength="5" label="中文名" name="gstNamec" id="gstNamec" type="text">
										</td>
