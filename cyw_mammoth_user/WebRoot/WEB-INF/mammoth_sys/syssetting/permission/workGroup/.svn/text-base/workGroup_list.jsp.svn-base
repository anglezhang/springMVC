...
<div class="center">
    <div class="main" id="webMain">
    	<div class="mainInfo">
        	<h4 class="fontWeight green margin-top-10">工作组设置</h4>
            <div class="mainMation margin-top-5">
            	<div class="tableDiv tabInformation" id="theGrid">
                </div>
            </div>
            <!-- choice -->
			<form id="searchId" action="${ctx}/workGroup/list.do" method="post">
	            <div class="choice">
...
<!--列表ALERT-->
<div id="workGroupAuthListAlert" class="alertDiv groupTransfer moveBar">
	<div class="alertMain greyBg" style="width:930px;margin-top:100px;">
    	<h4 class="moveDivAlert2">页面功能控件设置<a href="javascript:closeDiv('workGroupAuthListAlert');" class="closeDiv2"></a></h4>
		<iframe id="workGroupAuthListFrame" name="workGroupAuthListFrame" src="" style="margin: 0 8px 8px; width: 914px; height: 600px;border: 0;box-shadow: 1px 0 15px 2px #464646;"></iframe>
    </div>
</div>
<!--列表ALERT-->
</body>
<script type="text/javascript">
	$(function(){
		...
		// 初始化列表
		fillWorkGroupTable(dataJson,status_search);
	});
</script>
<script src="${ctx}/js/syssetting/permission/workGroup_list.js" type="text/javascript" ></script>
