	...
	<div class="alertMain greyBg" style="width:1040px; margin-top:120px;">
		...
		<div class="borderSolid">
			...
			<div class="leaveTheRoomL">
				...
				<!--留房表格Table-->
				<div class="tableDiv whiteBackground floatL" style="width:480px;margin-top:7px;height: 235px;" id="bookCheckInInfoList"></div>
				<ul id="alreadyCheckInPersonListUL" class="roomNum floatR roomUl marginRight-2">
				</ul>
				<!--/留房表格Table-->
			</div>
			<!--留房弹出框左侧END-->
					...
					<div class="choice padding-bottom-10">
						<table width="60%" class="margin-left-50">
							<tr>
								...
								<td align="center"><label><input name="radio1"
										type="radio"><span class="margin-left-10">全选</span> </label>
								</td>
							</tr>
						</table>
									...
									<tr>
										...
										<td>
											<table width="100%">
												<tr>
													<td style="padding:0;">
														<input class="input" name="roomType" id="roomType" type="text" readonly="readonly">
									...
									<tr>
										...
										<td>
											<table width="100%">
												<tr>
													<td style="padding:0;">
														<input class="input" name="roomCharater" id="roomCharater" type="text" readonly="readonly"> 
						...
						<div class="clearBoth"></div>
						<a class="button_06 floatL margin-left-30" href="javascript:checkInputFormSearch(true , false);">条件查询</a>
						<a class="button_06 floatL margin-left-30" href="javascript:clearCheckInputForm();">清空条件</a>
						<div class="clearBoth"></div>
						...
						<a id="confirmSelect" class="button_06 floatL margin-left-30" href="javascript:;" style="cursor: not-allowed;color: grey;">确定选中</a> 
						<a id="confirmGiveUpSelect" class="button_06 floatL margin-left-30" href="javascript:;" style="cursor: not-allowed;color: grey;">全部放弃</a> 
						<a class="button_06 floatL margin-left-30" href="javascript:alert('自动排房');">自动排房</a> 
						<a id="confirmAllReach" class="button_06 floatL margin-left-30" href="javascript:confirmAllReach();">全部抵达</a> 
						<a id="saveCheckIn" class="button_06 floatL margin-left-30" href="javascript:;">办理入住</a> 
						<a class="button_06 floatL margin-left-30" href="javascript:closeBookRegistration();">退&nbsp;&nbsp;出</a>
						<div class="clearBoth"></div>
					</div>
				</div>
			</div>
