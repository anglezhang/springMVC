...
import static com.cyw.common.web.Constants.POST;
import static com.cyw.common.web.Constants.UTF8;
...
public class RequestUtils {
   ...
   /**
    * Checks if is curr user id.
    *
    * @param request the request
    * @param id the id
    * @return true, if is curr user id
    */
   public static boolean iscurrUserId(HttpServletRequest request,Integer id){
	  /* ZmUser user=null;
	   user=(ZmUser) request.getSession().getAttribute("user");
