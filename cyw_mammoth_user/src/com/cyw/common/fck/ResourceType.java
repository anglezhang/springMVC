...
public class ResourceType {
	 ...
	 * @param path            the absolute path of the new resource type
	 * @param allowedEextensions            the allowed extensions set of the new resource type
	 * @param deniedExtensions            the denied extensions set of the new resource type
	 */
