...
public interface HcountrySvc extends BaseSvc<Hcountry, Integer> {
	/**
	 * 根据条件查询列表
	...
	* @author Sixp
	 */
    List<Hcountry> findListBy(Integer status) throws Exception;
	/**
	 * 修改实体状态
	...
	/**
	 * 批量保存，修改，删除实体
	 * @param hcountrys  实体对象集合
	 * @param delIds  删除ids
	 * @throws Exception
	 * @author Sixp
	 */
	void saveOrUpdateOrDel(List<Hcountry> hcountrys, String delIds)  throws Exception;
}
