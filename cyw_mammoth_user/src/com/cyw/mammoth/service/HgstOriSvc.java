...
public interface HgstOriSvc extends BaseSvc<HgstOri, Integer> {
	...
	* @author Sixp
	 */
    List<HgstOri> findListBy(Integer status) throws Exception;
	/**
	 * 修改实体状态
	...
	/**
	 * 批量保存，修改，删除实体
	 * @param hgstOris  实体对象集合
	 * @param delIds  删除ids
	 * @throws Exception
	 * @author Sixp
	 */
	void saveOrUpdateOrDel(List<HgstOri> hgstOris, String delIds)  throws Exception;
